    ...
    <div className="container mx-auto px-4 py-16">
      ...
      <section className="mb-16">
        ...
        <p className="text-gray-700 mb-6">
          Here you will find the content of our YouTube channel.
        </p>
        ...
        <div className="flex justify-center">
          <iframe
            width="100%"
            height="500"
            src="https://www.youtube.com/embed?listType=user_uploads&list=sus-soil"
            title="SUS-SOIL YouTube Channel"
            frameBorder="0"
            allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
            allowFullScreen
            className="rounded-lg shadow-lg w-full md:w-[800px]"
          ></iframe>
        </div>
      </section>
    </div>
