...
// Normalized export: always expose `regionIds` while keeping legacy `regionId`.
export const livingLabs = rawLivingLabs.map((lab) => {
  const regionIds = Array.isArray(lab.regionIds)
    ? lab.regionIds
  ...
  return {
    ...lab,
    regionIds,
    regionId: lab.regionId || regionIds[0] || null,
  };
});
